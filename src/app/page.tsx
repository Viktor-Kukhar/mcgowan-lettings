      ...
      <section className="bg-cream py-16 md:py-24">
        <div className="max-w-7xl mx-auto px-6">
          <AnimateIn className="text-center max-w-2xl mx-auto mb-16">
            ...
            <p className="text-text-muted text-sm mb-3">Rated 5 stars on Google Reviews</p>
            <a
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {TESTIMONIALS.map((testimonial, i) => (
              <AnimateIn key={i} delay={i * 0.1}>
                <div className="bg-white rounded-lg p-8 border border-black/5 relative">
                  ...
                  <div className="relative">
                    ...
                    <p className="text-dark/80 text-sm leading-relaxed mb-6">{testimonial.text}</p>
